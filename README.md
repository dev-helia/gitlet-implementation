...
| 所在类               | 功能               | 作用                        | **优先级** | **状态** |
| ----------------- | ---------------- | ------------------------- | ------- | ------ |
| `Commit.java`     | 构造器,getter       | 供`Repository.java`使用      | 🟢 1    | ✅已完成   |
| `Repository.java` | `init`           | 初始化 Gitlet 版本库            | 🟢 1    | ✅已完成   |
| `Repository.java` | `add`            | 添加文件到暂存区                  | 🟢 1    | ✅已完成   |
| `Repository.java` | `commit`         | 提交新信息.                    | 🟢 1    | ✅已完成   |
| `Repository.java` | `log`            | 加载commit信息.               | 🟢 2    | ✅已完成   |
| `Repository.java` | `checkout`       | 实现 `checkout`，回到旧的 commit | 🟡 3    | ✅已完成   |
| `Repository.java` | `branch`         | 实现 `branch`，创建新分支         | 🟡 3    | ✅已完成   |
| `Repository.java` | `rm`, `rmBranch` | 实现commit和branch的删除.       | 🟢 4    | ✅已完成   |
| `Repository.java` | `reset`          | 实现退回commit的版本.            | 🟢 4    | ✅已完成   |
| `Repository.java` | `merge`          | **实现 `merge`，合并分支**       | 🔴 5    | 🚧 还没做 |
